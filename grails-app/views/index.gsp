    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse" aria-expanded="false" style="height: 0.8px;" uib-collapse="!navExpanded">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    <a class="navbar-brand" href="/#/radar/show/1">View Radar</a>
                </li>

                <li class="dropdown">
                    <a class="list" ui-sref="quadrant.list" class="list">Quadrants</a>
                </li>
                <li class="dropdown">
                    <a class="list" ui-sref="item.list" class="list">Radar Items</a>
                </li>
                <li class="dropdown" uib-dropdown>
                    ...
                    <ul class="dropdown-menu" uib-dropdown-menu>
                        ...
                        <li><a target="_blank"
                               href="https://grails-plugins.github.io/grails-angular-scaffolding/latest/">Angular Scaffolding</a>
                        </li>
                        <li><a target="_blank"
                               href="https://www.thoughtworks.com/radar">Thoughtworks Technology Radar</a></li>
                    </ul>
                </li>
            </ul>
        </div>
